...
function _testPostalCode(postalCode) {
  var result = false; // eslint-disable-next-line no-plusplus
...
var _default = new _graphql.GraphQLScalarType({
  ...
  serialize: function serialize(value) {
    ...
    if (!_testPostalCode(value)) {
      throw new TypeError("Value is not a valid postal code: ".concat(value));
    }
  ...
  parseLiteral: function parseLiteral(ast) {
    ...
    if (!_testPostalCode(ast.value)) {
      throw new TypeError("Value is not a valid postal code: ".concat(ast.value));
    }
