...
function generateIndexName(table, columns, options) {
  return options.name ? options.name : ((tableName, cols, uniq) => template`${tableName}_${cols}${uniq}_index`)(table, _.isArray(columns) ? columns.join("_") : columns, options.unique ? "_unique" : "");
}
